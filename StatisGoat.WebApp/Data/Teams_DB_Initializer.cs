...
{
    public class Teams_DB_Initializer
    {
        public static void Initialize(Teams_DB context)
        {
            ...
            // If we want to seed the database with fake teams, this is where that will go.
