...
{
    public class Players_DB_Initializer
    {
        public static void Initialize(Players_DB context)
        {
            ...
            // If we want to seed the database with fake players, this is where that will go.
